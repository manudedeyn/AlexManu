...
public class DemoPresentation {
    ...
    public static Presentation getPresentation() {
    	...
    	presentationBuilder.createPresentation("Demo Presentatie")
			.createSlide("JabberPoint", TransitionTypes.SLIDE.toString())
			...
			.createSlide("Demonstratie van levels en stijlen", TransitionTypes.SLIDE.toString())
			...
			.createSlide("Demonstratie van transities", TransitionTypes.SLIDE_ITEM.toString())
				.createSlideItem("text", "Level 1", 1)
				.createSlideItem("text", "Level 2", 2)
				.createSlideItem("text", "Nogmaals level 1",1)
				.createSlideItem("text", "Level 1 heeft stijl nummer 1",1)
				...
				.createSlideItem("text", "Zo ziet level 3 er uit",3)
				.createSlideItem("text", "En dit is level 4",4)
			.createSlide("De derde slide", TransitionTypes.SLIDE.toString())
